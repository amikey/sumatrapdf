...
protected:
    ...
    Bitmap *LoadBitmap(int pageNo, bool& deleteAfterUse) override;
...
std::vector<std::wstring> ImageEngineImpl::GetProperties() {
    CrashMe();
...
public:
    ...
    ~CbxEngineImpl() override { delete cbxFile; }
...
BaseEngine *CbxEngineImpl::Clone() {
    if (fileStream) {
...
std::vector<std::wstring> CbxEngineImpl::GetProperties() {
    CrashMe();
    return std::vector<std::wstring>();
}
