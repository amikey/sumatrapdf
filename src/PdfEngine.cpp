...
public:
    ...
    virtual RectD PageMediabox(int pageNo) override;
...
std::vector<std::wstring> PdfEngineImpl::GetProperties() {
    CrashMe();
...
public:
    ...
    PageDestination *AsLink() override { return this; }
